...
-- ─── Personal Invitations live in Payload ─────────────
-- See payload.config.ts. Payload manages its own tables in the
-- 'payload' Postgres schema (invites, invite-sessions,
-- invite-access-logs, users). Nothing to migrate here.
